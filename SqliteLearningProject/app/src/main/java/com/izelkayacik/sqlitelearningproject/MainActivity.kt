package com.izelkayacik.sqlitelearningproject
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try{
            ...
            //veritabani.execSQL("INSERT INTO urunler (isim, fiyat) VALUES ('Atki',100)")
            //veritabani.execSQL("INSERT INTO urunler (isim, fiyat) VALUES ('Bere',100)")

            //veritabani.execSQL("DELETE FROM urunler WHERE id = 5")
            //veritabani.execSQL("UPDATE urunler SET FİYAT = 250 WHERE isim ='Elbise'")
